...
if(isset($_GET['id']) && $_GET['id']!="")
{
    ...
    $result = $dbHandler->ExecuteQuery("SELECT EmployeeOrClient FROM Users WHERE ID='{$id}'");
    $empOrClient = mysql_fetch_row($result);
    $empOrClient = $empOrClient[0];
    if(isset($_SESSION['LoggedIn']) && ($_SESSION['userinfo']['CanCreateAccounts'] == "a" || ($_SESSION['userinfo']['CanCreateAccounts'] == "c" && $empOrClient != "e")))
    {
        ...
        <?php
            ...
            {
                echo "<span class=\"NegativeMessage\">".ACCOUNT_NOT_FOUND_TEXT."</span>";
            }
        }
        else
        {
