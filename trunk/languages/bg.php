...
define("REMOVE_INSTALL_TEXT","Минала е поне една инсталация. Ако всичко е минало нормално, и сте сигурни че въведените данни
    са верни, моля изтрийте <i>install</i> директорията. В противен случай, можете да повторите инсталацията.");
?>